...
, SeriesAggregated AS (
    SELECT
        ...
        ChampionTeam,
        RunnerupTeam,
        AVG(CAST(SUBSTRING(CAST(IFNULL(ChampionTOV, 0) AS CHAR), 1, 4) AS DECIMAL(10, 4))) AS TotalChampionTOV,
        AVG(CAST(SUBSTRING(CAST(IFNULL(RunnerupTOV, 0) AS CHAR), 1, 4) AS DECIMAL(10, 4))) AS TotalRunnerupTOV,
        SUM(CAST(SUBSTRING(CAST(IFNULL(ChampionFG, 0) AS CHAR), 1, 4) AS DECIMAL(10, 4))) AS TotalChampionFGM,
        SUM(CAST(SUBSTRING(CAST(IFNULL(RunnerupFG, 0) AS CHAR), 1, 4) AS DECIMAL(10, 4))) AS TotalRunnerupFGM,
        AVG(CAST(SUBSTRING(CAST(IFNULL(ChampionORB + ChampionDRB, 0) AS CHAR), 1, 4) AS DECIMAL(10, 4))) AS AVGChampionREB,
        AVG(CAST(SUBSTRING(CAST(IFNULL(RunnerupORB + RunnerupDRB, 0) AS CHAR), 1, 4) AS DECIMAL(10, 4))) AS AVGRunnerupREB,
        SUM(CAST(SUBSTRING(CAST(IFNULL(ChampionFT, 0) AS CHAR), 1, 4) AS DECIMAL(10, 4))) AS AVGChampionFTP,
        SUM(CAST(SUBSTRING(CAST(IFNULL(RunnerupFT, 0) AS CHAR), 1, 4) AS DECIMAL(10, 4))) AS AVGRunnerupFTP
